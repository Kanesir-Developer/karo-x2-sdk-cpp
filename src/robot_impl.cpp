...
std::unique_ptr<Subscription> RobotImpl::SubscribeSafetyEvents(
  ...
  return SubscribeInternal("robot.safety", 0.0, std::move(fd),
                           std::move(on_status));
}
...
CreateTaskResult RobotImpl::CreateNavigationTaskToMarker(const std::string& marker_id) {
  ...
  auto out = InvokeRpc("move.create_task", opts_.estop_rpc_timeout,
...
TaskCommandResult RobotImpl::CancelTask(const std::string& task_id) {
  ...
  auto out = InvokeRpc("task_actions.cancel_task", opts_.estop_rpc_timeout,
...
TaskCommandResult RobotImpl::PauseTask(const std::string& task_id) {
  ...
  auto out = InvokeRpc("task_actions.pause_task", opts_.estop_rpc_timeout,
...
TaskCommandResult RobotImpl::ResumeTask(const std::string& task_id) {
  ...
  auto out = InvokeRpc("task_actions.resume_task", opts_.estop_rpc_timeout,
